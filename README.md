...
- [Complex values at the machine boundary](notes/complex-machine-representations.md) — preserve the Android ARM polar-pair experiment, x86 Cartesian SSE register pairs, GLSL `vec2` lowering, F16/F32 policy, PowerVR evidence boundaries, and the unresolved representation choices rather than flattening them into “two floats.”
